...
import com.dream.miniboss.bean.UserInfo
import com.dream.miniboss.common.MmkvConstant
import com.dream.miniboss.common.MmkvConstant.KEY_ACCESS_TOKEN
import com.dream.miniboss.common.MmkvConstant.KEY_ACCOUNTID
import com.dream.miniboss.common.MmkvConstant.KEY_REFRESH_TOKEN
import com.dream.miniboss.common.MmkvConstant.KEY_VISIBLE_INVITE
import com.dream.miniboss.common.MmkvConstant.KEY_VISIBLE_MYMONEY
import com.dream.miniboss.common.MmkvConstant.KEY_VISIBLE_PARTNER
import com.dream.miniboss.common.MmkvConstant.KEY_VISIBLE_PROFIT
import com.dream.miniboss.common.MmkvConstant.KEY_VISIBLE_WALLET
...
object UserManager {
    ...
    init {
        ...
        LogUtils.iTag("tiaozi", "本地储存的用户信息--->${userInfo}")
    ...
    fun isLogin(): Boolean {
        ...
        LogUtils.i("tiaozi", "result:$result ,accessToken->$access")
        return result
    }
