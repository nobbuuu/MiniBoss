...
import com.tcl.base.weiget.IConsecutiveScroller;
...
public class ScrollUtils {
    ...
    public static int getRawX(View rootView, MotionEvent ev, int pointerIndex) {
    ...
    public static int getRawY(View rootView, MotionEvent ev, int pointerIndex) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
    ...
    public static boolean startInterceptRequestLayout(RecyclerView view) {
    ...
    public static void stopInterceptRequestLayout(RecyclerView view) {
        if ("InterceptRequestLayout".equals(view.getTag())) {
            try {
     ...
     * @return
     */
    public static boolean isHorizontalScroll(View rootView, int touchX, int touchY) {
     ...
     * @return
     */
    public static boolean isTouchNotTriggerScrollStick(View rootView, int touchX, int touchY) {
     ...
     * @return
     */
    public static List<ConsecutiveScrollerLayout> getInTouchCSLayout(View rootView, int touchX, int touchY) {
    ...
    public static View getTopViewInTouch(ConsecutiveScrollerLayout csl, int touchX, int touchY) {
